...
The good news is that this revolution has already started. You can read more about it in my article here, but suffice to say, this movement is still in its infancy. To me, solving the junior engineer placement problem means helping EMPLOYERS adopt these new tools and processes which make software engineering easier. It means standardizing and aligning on best practices across the industry, instead of trying to create “senior” engineers that can jump into any stack. 
